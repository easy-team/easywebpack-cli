...
module.exports = class Command extends Logger {
  ...
  init() {
    this.program
      .command('init')
      .option('-r, --registry [url]', 'npm registry, default https://registry.npmjs.org, you can taobao registry: https://registry.npmjs.org')
      .option('--package [name]', 'download npm package name')
  ...
  add() {
    this.program
      .command('add')
      .option('--registry [url]', 'npm registry, default https://registry.npmjs.org, you can taobao registry: https://registry.npmjs.org')
