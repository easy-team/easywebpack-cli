...
exports.boilerplateChoice = [
  ...
  {
    name: `Create ${chalk.green('NPM')} Package Template`,
...
exports.boilerplateDetailChoice = {
  ...
  'boilerplate-egg-vue': [
    ...
    {
      name: `Create ${chalk.green('Egg + Vue')} ${chalk.yellow('Server Side Render(SSR)')} Awesome Application`,
      value: 'egg-vue',
      pkgName: 'egg-vue-webpack-boilerplate'
    },
    {
      name: `Create ${chalk.green('Egg + Vue + TypeScript')} ${chalk.yellow('Server Side Render(SSR)')} Application`,
      value: 'egg-vue-typescript',
      pkgName: 'egg-vue-typescript-boilerplate'
    },
    {
      name: `Create ${chalk.green('Egg + Vue + Vuex + Vue-Router')} ${chalk.yellow('Server Side Render(SSR)')} Application`,
      value: 'egg-vue-spa',
      pkgName: 'egg-vue-webpack-spa-boilerplate'
    },
    {
      name: `Create ${chalk.green('Egg + Vue + Vuex + Vue-Router')} ${chalk.yellow('Client Side Render(CSR)')} Application`,
      value: 'easy-element-admin',
      pkgName: 'easy-element-admin'
    },
    {
      name: `Create ${chalk.green('Vue Server Side Render')} Application for ${chalk.yellow('Res(Egg+Vue)')} Framework`,
      value: 'ves',
      pkgName: 'ves-admin'
    }
  ],
  'boilerplate-egg-react': [
    ...
    {
      name: `Create ${chalk.green('Egg + React')} ${chalk.yellow('Server Side Render(SSR)')} Awesome Application`,
      value: 'egg-react',
      pkgName: 'egg-react-webpack-boilerplate'
    },
    {
      name: `Create ${chalk.green('Egg + React + TypeScript')} ${chalk.yellow('Server Side Render(SSR)')} Application`,
      value: 'egg-react-typescript',
      pkgName: 'egg-react-typescript-boilerplate'
    },
    {
      name: `Create ${chalk.green('Egg + React + React Router + Redux')} ${chalk.yellow('Server Side Render(SSR)')} Application`,
      value: 'egg-react-spa',
      pkgName: 'egg-react-webpack-spa-boilerplate'
    },
    {
      name: `Create ${chalk.green('Egg + React + React Router + Redux')} ${chalk.yellow('Client Side Render(CSR)')} Application`,
      value: 'easy-react-admin',
      pkgName: 'easy-react-admin'
    },
    {
      name: `Create ${chalk.green('React Server Side Render')} Application for ${chalk.yellow('Res(Egg+React)')} Framework`,
      value: 'res',
      pkgName: 'res-awesome'
    }
  ]
