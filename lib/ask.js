...
exports.boilerplateDetailChoice = {
  ...
  'boilerplate-react': [
    {
      name: `Create ${chalk.green('React')} ${chalk.yellow('Test')} Application`,
  ...
  'boilerplate-egg-vue': [
    ...
    {
      name: `Create ${chalk.green('Egg + Vue Single Page')} ${chalk.yellow('Server Side Render')} Application`,
      value: 'egg-vue-spa',
      pkgName: 'egg-vue-webpack-spa-boilerplate'
    },
    {
      name: `Create ${chalk.green('Egg + Vue Multil Page')} ${chalk.yellow('Server Side Render')} Application`,
      value: 'egg-vue-multil',
      pkgName: 'egg-vue-webpack-mpa-boilerplate'
    },
    {
      name: `Create ${chalk.green('Egg + Vue Single And Multil Page')} ${chalk.yellow('Server Side Render')} Application`,
      value: 'egg-vue',
  ...
  'boilerplate-egg-react': [
    {
      name: `Create ${chalk.green('Egg + React + Nunjucks')} Application`,
    ...
    {
      name: `Create ${chalk.green('Egg + React + AntD')} ${chalk.yellow('Client Side Render')} Admin Application`,
      value: 'easy-react-admin',
      pkgName: 'easy-react-admin'
    },
    {
      name: `Create ${chalk.green('Egg + React Single Page')} ${chalk.yellow('Server Side Render')} Application`,
      value: 'egg-react-spa',
      pkgName: 'egg-react-webpack-spa-boilerplate'
    },
    {
      name: `Create ${chalk.green('Egg + React Multil Page')} ${chalk.yellow('Server Side Render')} Application`,
      value: 'egg-react-multil',
      pkgName: 'egg-react-webpack-mpa-boilerplate'
    },
    {
      name: `Create ${chalk.green('Egg + React Single And Multil Page')} ${chalk.yellow('Server Side Render')} Application`,
      value: 'egg-react',
