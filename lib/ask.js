...
exports.boilerplateDetailChoice = {
  ...
  'boilerplate-egg-vue': [
    {
      name: `Create ${chalk.green('Egg + Element UI')} ${chalk.green('Client Render Single Page')} Application`,
      value: 'egg-vue-element-admin',
      pkgName: 'egg-vue-element-admin-boilerplate'
    },
    {
